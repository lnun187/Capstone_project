...
\end{figure}
    ...
    \subsection{Giao thức giao tiếp OSPI (Octal SPI)}
    ...
    \begin{itemize}
        ...
        \item \textbf{Số lượng chân ít:} So với các giao tiếp bộ nhớ song song truyền thống (Parallel Flash/SRAM) cần 30-40 chân, OSPI chỉ cần khoảng 12 chân, giúp tiết kiệm diện tích FPGA.
    \end{itemize}
