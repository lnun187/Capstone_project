...
\usepackage{graphicx}
\usepackage{caption}
\usepackage{subcaption} % Gói quan trọng để tạo hình (a), (b)
\usepackage{tabularx}
%=====================================================
% LANGUAGE & ENCODING
%=====================================================
...
\AtBeginDocument{
    ...
    % Định nghĩa tên hiển thị dưới mỗi hình/bảng
    \renewcommand{\figurename}{Hình}
    \renewcommand{\tablename}{Bảng}
    
    % Cấu hình tocloft để hiển thị "Hình 1.1" thay vì "1.1" trong danh sách
    \renewcommand{\cftfigpresnum}{Hình~}
    \renewcommand{\cftfignumwidth}{4.5em} % Tăng độ rộng để không bị đè chữ
    \renewcommand{\cftfigaftersnum}{:}    % Thêm dấu hai chấm nếu muốn (Hình 1.1:)
...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \textcolor{blue}{\Large{\textbf{Thiết kế SoC RISC-V tích hợp EdgeAI \\ cho ứng dụng IoT}}}\\
        \vspace{20pt}
        \hrule
    \end{center}
...
\listoftables
\newpage
\include{tom_tat/danh_muc_ky_hieu}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{ket_qua_thuc_nghiem/main} 
