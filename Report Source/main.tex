...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \textbf{FALTY OF COMPUTER SCIENCE AND ENGINEERING}\\
        \vspace{10pt}
        ...
        \hrule
        \vspace{20pt}
        \textcolor{blue}{\Large{\textbf{Motion Planning around Obstacles}}}\\
        \vspace{20pt}
        \hrule
    \end{center}
    ...
    \begin{center}
       ...
       \vspace{10pt}
        \textbf{Instructor:} Assoc. Prof. Le Hong Trang 
    \end{center}
    ...
    \begin{adjustbox}{width=0.94\textwidth,center=\textwidth}
        ...
        \begin{tabular}{|>{\centering\arraybackslash}m{1cm}|>{\centering\arraybackslash}m{5.3cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{4cm}|}
            \hline
            \textbf{STT} & \textbf{Full name} & \textbf{ID} & \textbf{Note}\\
            \hline
