...
\begin{itemize}
    ...
    \item \textbf{Về xử lý AI:} Thiết kế khối Accelerator chuyên dụng hỗ trợ các phép toán trọng yếu của mạng nơ-ron tích chập (CNN) như Tích chập (Convolution), Pooling và hàm kích hoạt (Activation), nhằm giảm tải cho CPU và tăng tốc độ xử lý thực tế.
