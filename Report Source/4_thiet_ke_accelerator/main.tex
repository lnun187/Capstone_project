...
Hệ thống sử dụng hai bộ đệm đầu ra ($\text{Buffer}_A, \text{Buffer}_B$) luân phiên vai trò để xử lý vấn đề này:
\begin{enumerate}
...
\subsubsection{Cơ chế hoạt động và tối ưu hóa tham số}
